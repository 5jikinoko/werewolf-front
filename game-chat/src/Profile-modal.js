...
export default function ProfileModal(props) {
    ...
    useEffect(() => {
        ...
        if (roomID !== null) {
            ...
            .then(json => {
                ...
                usedNameList = usedNameList.slice().concat(json.usedNameList);
            })
            .catch((error) => {
                console.error(error);
            });
    ...
    const registerProfile = () => {
        ...
        fetch("http://160.16.141.77:51000/profile-register?announce=true&checkDuplicates=" + roomID, {
            method: "PUT",
            body: fd
        })
        .then((response) => {
            ...
            <div className="col">
                ...
                <div className="col align-self-center" style={{width:"250px", paddingLeft:"10%"}}>
                    ...
                    <div className="d-flex align-items-center justify-content-center">
                        <IconSelectModal roomID={props.roomID} nowIcon={icon} onClick={selectIcon}/>
                    </div>
                </div>
